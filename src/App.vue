            ...
            <div class="flex items-center justify-between">
                ...
                <div class="menu-right">
                    <template v-if="userStore.user.isAuthenticated">
                        <a href="#">
                            <img src="src/assets/1.jpeg" class="rounded-full h-12 w-12">
                        </a>
                    </template>

                    <template v-else>
                        <RouterLink to="/login" class="mr-4 py-4 px-6 bg-gray-600 text-white rounded-lg">Log in</RouterLink>
                        <RouterLink to="/signup" class="py-4 px-6 bg-sky-500 hover:bg-sky-700 ... text-white rounded-lg">Sign up</RouterLink>
                    </template>
                </div>
            </div>
        </div>
