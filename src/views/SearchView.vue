        ...
        <div class="main-left col-span-3 space-y-4">
            <div class="bg-white border border-gray-200 rounded-lg">
                <form v-on:submit.prevent="submitForm" class="p-4 flex space-x-4">  
                    ...
                    <button class="inline-block py-4 px-6 bg-sky-500 hover:bg-sky-700  text-white rounded-lg">
            ...
            >
                ...
                >
                    ...
                    <p>
                        <strong>
                            <RouterLink :to="{name: 'profile', params:{'id': user.id}}">{{ user.name }}</RouterLink>dd
                        </strong>
                    </p>
